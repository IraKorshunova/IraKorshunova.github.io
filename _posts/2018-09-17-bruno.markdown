...
[^1]: If you can be very patient with sampling, then autoregressive models such as [MAF](https://arxiv.org/abs/1705.07057) might perform better. We have't tried them since Real NVP was doing well already. Neither, we tried [Glow](https://arxiv.org/abs/1807.03039) -- an improved version of Real NVP. 
